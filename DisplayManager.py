...
class DisplayManager:
	...
	def displayTrendingGraph(self, dayTrend):
			...
			if self.screenWidth > 1000:
				# larger screens
				self.drawText(x0 - 200, y0 + graph_height - 10, f"Freq Trend (hourly, last 24h {24 - start_idx}h left)")
				self.drawText(x0 - 200, y0 + graph_height + 8, f"Start: {start_idx:02d}:00")
